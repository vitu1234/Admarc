                            ...
                            if (isset($_GET['category']) && !empty($_GET['category'])) {
                                ...
                                foreach ($categories as $category) {
                                    if ($category['category_id'] == $_GET['category']) {
                                        ...
                                        echo '<li><a href="shop.php?category=' . $category['category_id'] . '" class="active">' . $category['category_name'] . '</a></li>';
                                    } else {
                                        echo '<li><a href="shop.php?category=' . $category['category_id'] . '" class="">' . $category['category_name'] . '</a></li>';
                                    }
                                }
                            } else {
