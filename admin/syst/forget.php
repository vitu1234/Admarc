<?php
$error = (!isset($_GET['error'])) ? '' : '<span style="width: 100%" class="mt-2 text-center text-danger alert alert-danger">' . $_GET['error'] . '*</span>';
?>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12 mt-5">
                            <div class="mdc-card">
                                ...
                                <div class="d-block d-sm-flex justify-content-center align-items-center">
                                    <h5 class="card-sub-title mb-2 mb-sm-0">Enter your email to reset your password</h5>
                                ...
                                <div class="mdc-layout-grid__inner mt-2 ">
                                    ...
                                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-6 mdc-layout-grid__cell--span-8-tablet">
                                        ...
                                        <form class="mt-2 py-2" id="forgetForm">
            ...
            $.ajax({ //make ajax request to cart_process.php
                ...
                data: form_data
                    ...
                    if (data.code == 1) {
                        ...
                        setTimeout(function () {
                            window.location = "reset_code.php";
                        }, 1000);
                    } else if (data.code == 2) {
                        Swal.fire({
                            icon: 'error',
